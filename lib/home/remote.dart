...
class Remote {
  Future<RemoteVaccines> getVaccines() async {
    ...
    Response<Map<String, dynamic>> response = await Dio().get('https://booking.covidvaccine.gov.hk/centre/data.json?_=$nowTs');
  ...
  Future<Set<CenterInfo>> getAllCenterLocationInfos() {
